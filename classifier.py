...
class Classifier():
    ...
    def predict(self, data_root, model_root, test_root, test_div, out_path, readable=False):
        ...
        model = load_model(model_fname,
                           custom_objects={'top1_acc': top1_acc, 'Attention': Attention})
    ...
    def train(self, data_root, out_dir):
        ...
        self.weight_fname = './model/train/weights' # os.path.join(out_dir, '/weights')
        ...
        model_fname = os.path.join('./model/train/', 'model.h5')
        model = load_model(model_fname, custom_objects={'top1_acc': top1_acc, 'Attention': Attention})
        model.summary()
